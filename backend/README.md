...
## Project Structure
    ...
    ├── testapiautoconnect_128220  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_128220`
...
2. Clone this repo and `cd testapiautoconnect_128220`
